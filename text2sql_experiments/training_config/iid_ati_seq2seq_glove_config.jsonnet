local local_dir = ""; 
{
  ...
  "train_data_path": local_dir +"data/sql data/atis/schema_full_split/aligned_train.json",
  "validation_data_path": local_dir +"data/sql data/atis/schema_full_split/aligned_final_dev.json",
  "trainer": {
    "cuda_device": -1,
